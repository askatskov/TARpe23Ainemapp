...
if ( ! class_exists( 'Presto_Blog_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Presto_Blog_Slider_Control extends WP_Customize_Control {

		public $type = 'presto-blog-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'presto-blog-slider', get_template_directory_uri() . '/inc/customizer-controls/slider/slider.css', null );
            wp_enqueue_script( 'presto-blog-slider', get_template_directory_uri() . '/inc/customizer-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
