...
Peregrine is a beautiful, extremely customizable, multipurpose theme that you can use to create an amazing website by drag and drop. It comes with a predesigned home page, 5 header designs and over 35 ready to use content blocks that you can easily customize. You can also design your own custom blocks by combining over 25 drag and drop components. Peregrine has lots of customization options (video background, slideshow background, header content types, etc) that will help you create a website that stands out in no time. It is also responsive so it works on mobile devices out of the box. Peregrine is the only theme you will ever need! CHECK OUT THE DEMOS: https://peregrine.com/go/demos


== Frequently Asked Questions ==

= How can I customize Peregrine? =

    To customize the Peregrine theme you have to open the Customizer by accessing the Appearance menu -> Customizer.


== License ==

Peregrine WordPress theme, Copyright (C) 2021 ExtendThemes
Peregrine WordPress theme is licensed under the GPL3.
...
* Images
    ...
    These assets are distributed under the CC0 License
        ...
        Source: https://pxhere.com/en/photo/1365953
        ...
        License: CC0 1.0 Universal (CC0 1.0)
        Source: https://openverse.org/image/0bde0480-a265-45b0-be33-fb1ab964d655?q=vibrant
