...
if( ! class_exists( 'Presto_Blog_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class Presto_Blog_Radio_Image_Control extends WP_Customize_Control {

		public $type = 'presto-blog-radio-image';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'presto-blog-radio-image', get_template_directory_uri() . '/inc/customizer-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'presto-blog-radio-image', get_template_directory_uri() . '/inc/customizer-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
